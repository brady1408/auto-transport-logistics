...
func DamageSection(groups []VehicleDamageGroup, labels store.DamageLabelMaps) templ.Component {
			...
			for _, g := range groups {
				...
				if len(g.DamagesWithPhotos) > 0 {
					...
					for _, dp := range g.DamagesWithPhotos {
						...
						templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(labels.Area(dp.Damage.DamageArea))
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/components/trips/damage_section.templ`, Line: 56, Col: 50}
						}
						...
						templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(labels.Type(dp.Damage.DamageType))
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/components/trips/damage_section.templ`, Line: 60, Col: 50}
						}
						...
						templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs(labels.Severity(dp.Damage.DamageSeverity))
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/components/trips/damage_section.templ`, Line: 64, Col: 58}
						}
				...
				if len(g.InspectionPhotos) > 0 {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 28, "<h4 style=\"margin: 0 0 0.25rem 0; font-size: 0.875rem; text-transform: uppercase; color: var(--text-muted);\">General Inspection Photos</h4><p class=\"text-muted\" style=\"font-size: 0.8rem; margin-bottom: 0.5rem;\">These photos were uploaded before per-damage photo tracking and are not linked to a specific damage record.</p>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
