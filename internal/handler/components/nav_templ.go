...
func Nav(user auth.ContextUser, companyName string, features models.FeatureSet, brand Brand) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<nav class=\"main-nav\" x-data=\"{ open: '', mobileOpen: false }\" @click.outside=\"open = ''; mobileOpen = false\" style=\"position:relative\"><div class=\"nav-brand\"><a href=\"/\">")
		if templ_7745c5c3_Err != nil {
		...
		if features.Has(models.FeatureLoadboard) {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<div class=\"nav-dropdown\" @click=\"open = open === 'loadboard' ? '' : 'loadboard'\"><button class=\"nav-link\">Loadboard</button><div class=\"dropdown-menu\" x-show=\"open === 'loadboard'\" x-cloak><a href=\"/loadboard\" class=\"dropdown-item\">Browse Loads</a> <a href=\"/loadboard/my-listings\" class=\"dropdown-item\">My Listings</a> <a href=\"/loadboard/my-claims\" class=\"dropdown-item\">My Claims</a></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<!-- Dispatch --><div class=\"nav-dropdown\" @click=\"open = open === 'dispatch' ? '' : 'dispatch'\"><button class=\"nav-link\">Dispatch</button><div class=\"dropdown-menu\" x-show=\"open === 'dispatch'\" x-cloak><a href=\"/dispatch/orders\" class=\"dropdown-item\">Orders</a> <a href=\"/dispatch/trips\" class=\"dropdown-item\">Trips/Loads</a> <a href=\"/dispatch/waiting\" class=\"dropdown-item\">Waiting Grid</a></div></div><!-- Accounting --><div class=\"nav-dropdown\" @click=\"open = open === 'accounting' ? '' : 'accounting'\"><button class=\"nav-link\">Accounting</button><div class=\"dropdown-menu\" x-show=\"open === 'accounting'\" x-cloak><a href=\"/accounting/invoices\" class=\"dropdown-item\">Invoices</a> <a href=\"/accounting/payments\" class=\"dropdown-item\">Payments</a> <a href=\"/accounting/credit-memos\" class=\"dropdown-item\">Credit Memos</a> <a href=\"/accounting/damage-claims\" class=\"dropdown-item\">Damage Claims</a> <a href=\"/accounting/ap\" class=\"dropdown-item\">Accounts Payable</a><hr class=\"dropdown-divider\"><a href=\"/accounting/driver-adjustments\" class=\"dropdown-item\">Driver Adjustments</a> <a href=\"/accounting/truck-adjustments\" class=\"dropdown-item\">Truck Adjustments</a><hr class=\"dropdown-divider\"><a href=\"/accounting/posting\" class=\"dropdown-item\">Period Posting</a></div></div><!-- Global --><div class=\"nav-dropdown\" @click=\"open = open === 'global' ? '' : 'global'\"><button class=\"nav-link\">Global</button><div class=\"dropdown-menu\" x-show=\"open === 'global'\" x-cloak><a href=\"/global/customers\" class=\"dropdown-item\">Customers</a> <a href=\"/global/employees\" class=\"dropdown-item\">Employees</a> <a href=\"/global/trucks\" class=\"dropdown-item\">Trucks</a> <a href=\"/global/vendors\" class=\"dropdown-item\">Vendors</a> <a href=\"/global/zones\" class=\"dropdown-item\">Zones</a> <a href=\"/global/zone-pricing\" class=\"dropdown-item\">Zone Pricing</a><hr class=\"dropdown-divider\"><a href=\"/global/dispatch-codes\" class=\"dropdown-item\">Dispatch Codes</a> <a href=\"/global/equipment-types\" class=\"dropdown-item\">Equipment Types</a> <a href=\"/global/items\" class=\"dropdown-item\">Items/Charges</a> <a href=\"/global/regions\" class=\"dropdown-item\">Regions</a> <a href=\"/global/terms\" class=\"dropdown-item\">Terms</a> <a href=\"/global/tax-codes\" class=\"dropdown-item\">Tax Codes</a><hr class=\"dropdown-divider\"><a href=\"/global/damage-areas\" class=\"dropdown-item\">Damage Areas</a> <a href=\"/global/damage-types\" class=\"dropdown-item\">Damage Types</a> <a href=\"/global/damage-severities\" class=\"dropdown-item\">Damage Severities</a> <a href=\"/global/hold-codes\" class=\"dropdown-item\">Hold Codes</a> <a href=\"/global/declination-codes\" class=\"dropdown-item\">Declination Codes</a></div></div><!-- Reports --><div class=\"nav-dropdown\" @click=\"open = open === 'reports' ? '' : 'reports'\"><button class=\"nav-link\">Reports</button><div class=\"dropdown-menu\" x-show=\"open === 'reports'\" x-cloak><a href=\"/reports\" class=\"dropdown-item\">All Reports</a><hr class=\"dropdown-divider\"><a href=\"/reports/ar-aging\" class=\"dropdown-item\">AR Aging</a> <a href=\"/reports/revenue-by-customer\" class=\"dropdown-item\">Revenue by Customer</a> <a href=\"/reports/payments\" class=\"dropdown-item\">Payment Report</a><hr class=\"dropdown-divider\"><a href=\"/reports/order-status\" class=\"dropdown-item\">Order Status</a> <a href=\"/reports/trip-summary\" class=\"dropdown-item\">Trip Summary</a> <a href=\"/reports/driver-settlement\" class=\"dropdown-item\">Driver Settlement</a> <a href=\"/reports/vehicle-history\" class=\"dropdown-item\">Vehicle History</a><hr class=\"dropdown-divider\"><a href=\"/reports/damages\" class=\"dropdown-item\">Damage Report</a></div></div><!-- Utilities --><div class=\"nav-dropdown\" @click=\"open = open === 'utilities' ? '' : 'utilities'\"><button class=\"nav-link\">Utilities</button><div class=\"dropdown-menu\" x-show=\"open === 'utilities'\" x-cloak><a href=\"/utilities/company\" class=\"dropdown-item\">Company Settings</a> <a href=\"/settings/subscription\" class=\"dropdown-item\">Subscription</a> ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if user.Role == "super_admin" {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "<!-- Admin (super_admin only) --> <div class=\"nav-dropdown\" @click=\"open = open === 'admin' ? '' : 'admin'\"><button class=\"nav-link\">Admin</button><div class=\"dropdown-menu\" x-show=\"open === 'admin'\" x-cloak><a href=\"/admin/companies\" class=\"dropdown-item\">Companies</a> <a href=\"/admin/backups\" class=\"dropdown-item\">Backups</a><hr class=\"dropdown-divider\"><a href=\"/admin/migration\" class=\"dropdown-item\">Migration</a> <a href=\"/admin/riverui/\" class=\"dropdown-item\">Job Queue</a> <a href=\"/admin/activity\" class=\"dropdown-item\">Activity</a> <a href=\"/admin/api-keys\" class=\"dropdown-item\">API Keys</a></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
