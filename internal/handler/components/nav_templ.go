...
func Nav(user auth.ContextUser, companyName string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "</div><div class=\"nav-user\"><!-- Notification bell --><div class=\"notification-bell\" x-data=\"{ open: false }\" @click.away=\"open = false\"><button class=\"bell-btn\" @click=\"open = !open; if(open) { htmx.ajax('POST', '/notifications/mark-read'); htmx.ajax('GET', '/notifications', {target: $refs.panel, swap: 'innerHTML'}) }\" type=\"button\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9\"></path><path d=\"M13.73 21a2 2 0 0 1-3.46 0\"></path></svg> <span hx-get=\"/notifications/count\" hx-trigger=\"load, every 30s\" hx-swap=\"innerHTML\"></span></button><div class=\"notification-panel\" x-show=\"open\" x-cloak x-ref=\"panel\"><p style=\"padding:1rem; color:var(--gray-400); text-align:center;\">Loading...</p></div></div><span>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/components/nav.templ`, Line: 130, Col: 24}
		}
