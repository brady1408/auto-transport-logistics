...
const (
	...
	CustomerServiceName = "atlinks.v1.CustomerService"
)
...
const (
	...
	// ListCustomers RPC.
	CustomerServiceListCustomersProcedure = "/atlinks.v1.CustomerService/ListCustomers"
	// CustomerServiceGetCustomerProcedure is the fully-qualified name of the CustomerService's
	// GetCustomer RPC.
	CustomerServiceGetCustomerProcedure = "/atlinks.v1.CustomerService/GetCustomer"
	// CustomerServiceCreateCustomerProcedure is the fully-qualified name of the CustomerService's
	// CreateCustomer RPC.
	CustomerServiceCreateCustomerProcedure = "/atlinks.v1.CustomerService/CreateCustomer"
	// CustomerServiceUpdateCustomerProcedure is the fully-qualified name of the CustomerService's
	// UpdateCustomer RPC.
	CustomerServiceUpdateCustomerProcedure = "/atlinks.v1.CustomerService/UpdateCustomer"
	// CustomerServiceDeleteCustomerProcedure is the fully-qualified name of the CustomerService's
	// DeleteCustomer RPC.
	CustomerServiceDeleteCustomerProcedure = "/atlinks.v1.CustomerService/DeleteCustomer"
)

// CustomerServiceClient is a client for the atlinks.v1.CustomerService service.
...
// NewCustomerServiceClient constructs a client for the atlinks.v1.CustomerService service. By
...
func NewCustomerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CustomerServiceClient {
	...
	customerServiceMethods := v1.File_atlinks_v1_customer_proto.Services().ByName("CustomerService").Methods()
...
// ListCustomers calls atlinks.v1.CustomerService.ListCustomers.
...
// GetCustomer calls atlinks.v1.CustomerService.GetCustomer.
...
// CreateCustomer calls atlinks.v1.CustomerService.CreateCustomer.
...
// UpdateCustomer calls atlinks.v1.CustomerService.UpdateCustomer.
...
// DeleteCustomer calls atlinks.v1.CustomerService.DeleteCustomer.
...
// CustomerServiceHandler is an implementation of the atlinks.v1.CustomerService service.
...
func NewCustomerServiceHandler(svc CustomerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/atlinks.v1.CustomerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCustomerServiceHandler) ListCustomers(context.Context, *connect.Request[v1.ListCustomersRequest]) (*connect.Response[v1.ListCustomersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("atlinks.v1.CustomerService.ListCustomers is not implemented"))
}
...
func (UnimplementedCustomerServiceHandler) GetCustomer(context.Context, *connect.Request[v1.GetCustomerRequest]) (*connect.Response[v1.GetCustomerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("atlinks.v1.CustomerService.GetCustomer is not implemented"))
}
...
func (UnimplementedCustomerServiceHandler) CreateCustomer(context.Context, *connect.Request[v1.CreateCustomerRequest]) (*connect.Response[v1.CreateCustomerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("atlinks.v1.CustomerService.CreateCustomer is not implemented"))
}
...
func (UnimplementedCustomerServiceHandler) UpdateCustomer(context.Context, *connect.Request[v1.UpdateCustomerRequest]) (*connect.Response[v1.UpdateCustomerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("atlinks.v1.CustomerService.UpdateCustomer is not implemented"))
}
...
func (UnimplementedCustomerServiceHandler) DeleteCustomer(context.Context, *connect.Request[v1.DeleteCustomerRequest]) (*connect.Response[v1.DeleteCustomerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("atlinks.v1.CustomerService.DeleteCustomer is not implemented"))
}
