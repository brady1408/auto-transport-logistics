...
ALTER TABLE order_vehicles ALTER COLUMN invoice_id TYPE bigint;
...
-- audit_log (user_id FK; record_id is polymorphic — convert both; company_id nullable)
ALTER TABLE audit_log ALTER COLUMN user_id TYPE bigint;
ALTER TABLE audit_log ALTER COLUMN record_id TYPE bigint;
ALTER TABLE audit_log ALTER COLUMN company_id TYPE bigint;
...
ALTER TABLE order_vehicles ALTER COLUMN invoice_id TYPE integer;
...
ALTER TABLE audit_log ALTER COLUMN company_id TYPE integer;
