...
CREATE INDEX IF NOT EXISTS idx_carriers_org_active ON carriers(organization_id, active);
...
CREATE INDEX IF NOT EXISTS idx_shipments_org_created ON shipments(organization_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_shipments_customer_id ON shipments(customer_id);
CREATE INDEX IF NOT EXISTS idx_shipments_carrier_id ON shipments(carrier_id);

-- Vehicles indexes
CREATE INDEX IF NOT EXISTS idx_vehicles_shipment_id ON vehicles(shipment_id);
